...
namespace GoogleFontDownloader
{
	...
	public class TriStateTreeView : System.Windows.Forms.TreeView
	{
		...
		// </remarks>
		public enum TriStateStyles : int { Standard = 0, Installer, GoogleFontDownloader };
        ...
        protected override void OnCreateControl()
		{
			...
			UpdateChildState(null, this.Nodes, (int)CheckedState.UnChecked, false, true);
			IgnoreClickAction--;
		}
        ...
        protected override void OnAfterCheck(System.Windows.Forms.TreeViewEventArgs e)
		{
            ...
            if (TriStateStyle == TriStateStyles.GoogleFontDownloader)
            {
                if(tn.Parent == null && tn.Nodes.Count > 0 && tn.Checked)
                {
                    foreach(System.Windows.Forms.TreeNode childNode in tn.Nodes)
                    {
			...
			UpdateChildState(e.Node, e.Node.Nodes, e.Node.StateImageIndex, e.Node.Checked, false);
		...
		// </summary>
		protected void UpdateChildState(System.Windows.Forms.TreeNode parent, System.Windows.Forms.TreeNodeCollection Nodes, int StateImageIndex, bool Checked, bool ChangeUninitialisedNodesOnly)
		{
            foreach (System.Windows.Forms.TreeNode tnChild in Nodes)
			{
                if (TriStateStyle == TriStateStyles.GoogleFontDownloader && Checked)
                    return;
                ...
                if (!ChangeUninitialisedNodesOnly || tnChild.StateImageIndex == -1)
				{
					...
					{
						UpdateChildState(parent, tnChild.Nodes, StateImageIndex, Checked, ChangeUninitialisedNodesOnly);
					}
				}
			}
		}
